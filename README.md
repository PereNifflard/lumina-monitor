...
téléphone — est dans [`docs/SECURITY.md`](docs/SECURITY.md). L'essentiel :
...
Le détail est dans [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) (la pile et
les murs rencontrés), [`docs/CORE_DESIGN.md`](docs/CORE_DESIGN.md) (la
bibliothèque), [`docs/VIDEO_DESIGN.md`](docs/VIDEO_DESIGN.md) (le flux),
[`docs/APP_DESIGN.md`](docs/APP_DESIGN.md) (la fenêtre) et
[`docs/SECURITY.md`](docs/SECURITY.md) (ce qui sort, ce qui est écrit).
...
[`experiments/BleProbe`](experiments/BleProbe/README.md), résultat négatif
